...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0a1628] text-white overflow-hidden" style={{ fontFamily: "'Outfit', sans-serif" }}>
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 px-6 py-4 flex items-center justify-between backdrop-blur-xl bg-[#0a1628]/80">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#4a0e8f] to-[#7c3aed] flex items-center justify-center shadow-lg shadow-purple-500/30">
        ...
        <div className="flex items-center gap-3">
          <Link href="/login" className="px-5 py-2.5 bg-gradient-to-r from-[#4a0e8f] to-[#7c3aed] hover:from-[#5b1aab] hover:to-[#8b5cf6] text-white text-sm font-semibold rounded-xl shadow-lg shadow-purple-500/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
      ...
      <section className="relative pt-28 pb-24 px-4 overflow-hidden perspective-container">
        {/* Background orbs */}
        <div className="absolute top-[-200px] left-[10%] w-[500px] h-[500px] rounded-full bg-[#4a0e8f]/20 blur-[150px] pointer-events-none"></div>
        <div className="absolute bottom-[-100px] right-[10%] w-[400px] h-[400px] rounded-full bg-[#d4a843]/10 blur-[120px] pointer-events-none"></div>
        <div className="absolute top-[30%] left-[50%] w-[300px] h-[300px] rounded-full bg-blue-600/10 blur-[100px] pointer-events-none"></div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          {/* Badge */}
          <div className="slide-up inline-flex items-center gap-2 border border-[#d4a843]/30 bg-[#d4a843]/10 px-4 py-1.5 rounded-full text-[#d4a843] text-xs font-bold tracking-widest uppercase mb-8 shadow-[0_0_20px_rgba(212,168,67,0.15)]">
            <span className="w-2 h-2 bg-[#d4a843] rounded-full animate-pulse"></span>
          ...
          <div className="perspective-container grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto slide-up slide-up-delay-4">
            <div className="card-3d bg-gradient-to-br from-[#0f2042] to-[#0a1628] border border-purple-500/20 rounded-2xl p-6 text-center">
      ...
      <section className="py-24 px-6 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a1628] via-[#0f1a30] to-[#0a1628] pointer-events-none"></div>
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="perspective-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div key={i} className="card-3d group bg-[#0f2042]/80 border border-white/5 rounded-2xl p-6 hover:border-purple-500/30 transition-all duration-500">
      ...
      <section className="py-24 px-6 relative border-t border-white/5">
        <div className="absolute top-0 left-[30%] w-[500px] h-[500px] rounded-full bg-[#4a0e8f]/10 blur-[150px] pointer-events-none"></div>
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-4">
            <div className="inline-flex items-center gap-2 border border-[#d4a843]/30 bg-[#d4a843]/10 px-4 py-1.5 rounded-full text-[#d4a843] text-xs font-bold tracking-widest uppercase mb-6">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto font-light mb-3">
              Proudly built by students of <strong className="text-[#d4a843]">Kalpataru Institute of Technology, Tiptur</strong>
            </p>
          ...
          <div className="perspective-container grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mt-12">
            {volunteers.map((v, i) => (
              <div key={i} className="card-3d group bg-[#0f2042]/80 border border-white/5 rounded-2xl p-5 text-center hover:border-[#d4a843]/30 transition-all duration-500">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#4a0e8f] to-[#7c3aed] flex items-center justify-center text-2xl mx-auto mb-3 group-hover:scale-110 transition-transform shadow-lg shadow-purple-500/20">
                  {v.emoji}
                </div>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex flex-col items-center bg-[#0f2042]/60 border border-white/5 rounded-2xl px-8 py-6">
              <i className="fa-solid fa-university text-[#d4a843] text-2xl mb-3"></i>
